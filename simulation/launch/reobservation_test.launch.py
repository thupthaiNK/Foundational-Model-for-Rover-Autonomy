"""
Purpose: Live Gazebo verification of "A2 re-observation mode" (scoped via
         grill-thesis 2026-07-19, item 7 of the L1-L6 further-work plan) --
         epistemic-uncertainty-driven exploration: the costmap keeps a
         per-cell latest-write confidence store (track_confidence), and
         once frontier exploration of the box is exhausted, the planner
         autonomously transitions to revisiting the known non-hazard cell
         with the LOWEST recorded confidence, one cell at a time, with no
         operator command at any transition.
